...
<template>
    <nav
        class="border-b border-black/5 bg-white/90 backdrop-blur supports-[backdrop-filter]:bg-white/70"
    >
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex h-16 items-center justify-between">
                ...
                >
                    <img :src="Logo" alt="Logo" class="h-[120px] w-auto" />
            ...
            <div class="space-y-1 py-2">
                ...
                <div>
                    ...
                    <div v-show="openGuestMobile" class="space-y-1 pb-2">
                        <Link
                            :href="routes.huesped"
                            class="block px-6 py-2 text-sm text-[#334155] hover:bg-[#0F3D3E]/5"
                            >Huésped
                        </Link>
                        <Link
