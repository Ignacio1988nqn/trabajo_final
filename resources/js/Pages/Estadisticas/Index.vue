...
onMounted(() => {
    // Pie: estado actual
    const dataEstados = Object.entries(props.estados || {}).map(
        ([estado, total]) => ({
            name: estado,
            y: total,
        })
    ...
    makePieChartEstados(
        ...
        "Distribución actual de todas las habitaciones"
    );

    // Pie: ocupación actual
    makePieChartOcupacion(
        props.ocupacionActual,
        "graficoOcupacion",
        ...
        <template #header>
            <div>
                ...
                <p class="mt-1 text-sm text-neutral-500">
                    Visualizá estadísticas de ocupación.
                </p>
            </div>
        </template>
