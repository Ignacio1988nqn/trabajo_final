...
export default {
    components: { Head, Link, AuthenticatedLayout, BaseButton },
    props: {
        items: Array,
    },
    setup() {
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <div class="flex justify-end mb-4">
                            <BaseButton to="gasto-items.create" :icon="false">
                                Nuevo Ítem
                            </BaseButton>
                        </div>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            >
                                                <img
                                                    :src="`/storage/gastoitems/gastoitem_${item.id}.jpg`"
                                                    alt="item.nombre"
                                        ...
                                        <td
                                            class="px-6 py-4 whitespace-nowrap text-sm font-bold text-green-700"
                                        >
                                            ${{
                                                Number(
                                                    item.precio
                                    ...
                                    <tr>
                                        ...
                                        >
                                            ...
                                            <p class="text-sm mt-2">
                                                Agregá bebidas, comidas o
                                                servicios para empezar a cobrar
                                                consumos.
                                            </p>
                                            <button
