...
import { useEstadoHabitaciones } from "@/composables/useEstadoHabitaciones";
...
// usamos los filtros iniciales que vienen del backend
const {
    numeroSeleccionado,
    estadoSeleccionado,
    tipoSeleccionado,
    ...
    numero: props.filtroNumero,
    estado: props.filtroEstado,
    tipo: props.filtroTipo,
});
</script>
        ...
        <template #header>
            <div>
                ...
                <p class="mt-1 text-sm text-neutral-500">
                    Gestiona estado y cambios habitación
                </p>
            </div>
        </template>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    class="w-full px-5 py-3 rounded-xl bg-white/20 backdrop-blur focus:outline-none focus:ring-4 focus:ring-white/30 transition text-white text-lg font-medium [appearance:none] [&_*]::text-white [&_*]::bg-indigo-700 [&_option]:bg-indigo-700 [&_option]:text-white [&_option:hover]:bg-indigo-600"
                                >
                                    <option value="todos">
                                        Todos los estados
                                    </option>
