                    ...
                    <div class="p-6 text-gray-900">
                        <div class="container mx-auto p-4">
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody v-if="huespedes.length" class="bg-white divide-y divide-gray-200">
                                    <tr v-for="huesped in huespedes" :key="huesped.id"
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span
                                                ...
                                                :class="{
                                                    'bg-blue-100 text-blue-800': huesped.tipo_huesped === 'persona',
                                                    'bg-purple-100 text-purple-800': huesped.tipo_huesped === 'empresa',
                                                    'bg-gray-100 text-gray-800': !huesped.tipo_huesped
                                                }">
                                                {{ huesped.tipo_huesped || 'desconocido' }}
                                            </span>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900">
                                            <div class="flex items-center">
                                                <!-- Icono según tipo -->
                                                <svg v-if="huesped.tipo_huesped === 'persona'"
                                                    class="w-5 h-5 text-gray-400 mr-3" fill="currentColor"
                                                    viewBox="0 0 20 20">
                                                    <path fill-rule="evenodd"
                                                        d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z"
                                                        clip-rule="evenodd" />
                                                </svg>
                                                <svg v-else class="w-5 h-5 text-gray-400 mr-3" fill="currentColor"
                                                    viewBox="0 0 20 20">
                                                    <path
                                                ...
                                                : (huesped.empresas?.razon_social || 'Sin razón social') }}
                                            </div>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-3">
                                            <Link :href="route('huesped.edit', huesped.id)"
                                            ...
                                            <button @click="destroy(huesped.id)"
                                ...
                                <tbody v-else>
                                    <tr>
                                        <td colspan="5" class="px-6 py-16 text-center text-gray-500 bg-gray-50">
                                            ...
                                            <p class="text-xl font-semibold text-gray-700">No hay huéspedes registrados
                                            </p>
                                            <p class="text-sm mt-2">Agregá personas o empresas para poder hacer
                                                reservas.</p>
                                            <Link :href="route('huesped.create')"
