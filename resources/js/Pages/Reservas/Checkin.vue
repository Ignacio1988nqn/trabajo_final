...
import CheckinFilterToggle from "@/Components/CheckinFilterToggle.vue";
        ...
        router.post(
            ...
            },
            {
                ...
                onError: (errors) => {
                    Swal.fire(
                        "Error",
                        errors?.error || "No se pudo realizar el check-in.",
                        "error"
                    );
                },
                preserveScroll: true,
        ...
        <template #header>
            <div>
                ...
                <p class="mt-1 text-sm text-neutral-500">
                    Gestiona la entrada de huespedes.
                </p>
            </div>
        </template>
                                ...
                                <tr>
                                    <td colspan="8" class="px-6 py-12 text-center text-gray-500 bg-gray-50">
                                        ...
                                        <p class="text-sm mt-1">
                                            Las reservas listas para hacer
                                            check-in aparecerán aquí.
                                        </p>
                                    </td>
                                </tr>
                            </tbody>
