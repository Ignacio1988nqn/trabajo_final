        ...
        <template #header>
            <div>
                ...
                <p class="mt-1 text-sm text-neutral-500">
                    Eliminar, editar y crear reservas
                </p>
            </div>
        </template>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <div class="p-6 text-gray-900 flex items-center gap-3">
                            <BaseButton to="reservas.create" :icon="false">
                                + Nueva Reserva
                            </BaseButton>

                            <BaseButton to="checkin.index" :icon="false">
                                Check In
                            </BaseButton>

                            <BaseButton to="checkout.index" :icon="false">
                                Check Out
                            </BaseButton>
                        </div>
